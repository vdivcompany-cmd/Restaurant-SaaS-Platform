...
export const customerEmbeddedSchema = z.object({
...
export const updateOrderStatusSchema = z.object({
  status: z.enum(['PENDING', 'CONFIRMED', 'PREPARING', 'READY', 'SERVED', 'PAID', 'COMPLETED', 'CANCELLED']),
  notes: z.string().max(500).optional(),
});

export const cashierConfirmSchema = z.object({
  notes: z.string().max(500).optional(),
});

export const kitchenCompleteSchema = z.object({
...
export type CustomerEmbeddedDto = z.infer<typeof customerEmbeddedSchema>;
...
export type CashierConfirmDto = z.infer<typeof cashierConfirmSchema>;
export type KitchenCompleteDto = z.infer<typeof kitchenCompleteSchema>;
