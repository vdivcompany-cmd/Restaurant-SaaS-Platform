# API Routes & Integration Manual ‚Äî Restaurant SaaS Platform
...
## üåê Root & Serverless Infrastructure Probes
...
## ü§ñ Phase 8 ‚Äî Cloud AI & n8n RAG Automation Gateways
...
## üîë Authentication Module (`/api/v1/auth`)
...
## üè¨ Tenant & Restaurant Management (`/api/v1/*`)
...
## üçΩÔ∏è POS Menu & Kitchen Operations (`/api/v1/*`)
...
## 9. ‚öôÔ∏è Shared Validation Kernel, Audit Telemetry & Analytical Snapshot Architecture
...
## ?? Phase 9 ó Correctness Fixes & Tenant-Context Rework
...
### 9.1 ó Subscriptions & Billing (super_admin Only)
...
### 9.5 ó Reservations Module (/api/v1/reservations)
